...
export function deleteCalendarEvent(day, currentYear, currentMonth) {
...
export function getCalendarEvents(dateStr = null, currentYear, currentMonth) {
...
export function initCalendar(showSpeechBubbleInChunks) {
  const now = new Date();
  currentYear = now.getFullYear();
  currentMonth = now.getMonth();
  populateYearSelect();
  renderCalendar(currentYear, currentMonth, showSpeechBubbleInChunks);
  ...
  if (deleteDayEvent) {
    deleteDayEvent.addEventListener("click", () => {
      ...
      if (dayStr) {
        ...
        const message = deleteCalendarEvent(dayNum, currentYear, currentMonth);
...
function renderCalendar(year, month, showSpeechBubbleInChunks) {
