...
/***** 날씨 효과 함수 (main.js에서 호출 가능하도록 전역으로 노출) *****/
...
function animate() {
  ...
  updateHouseClouds();
  updateLightning(""); // main.js에서 날씨 데이터를 받아야 함
...
// main.js에서 사용할 수 있도록 전역 함수로 노출
window.updateWeatherEffects = updateWeatherEffects;
